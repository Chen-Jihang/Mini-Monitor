...
void OLED_DrawRectangle(u8 x1,u8 y1,u8 x2,u8 y2,u8 mode)
{
		...
		OLED_DrawLine(x1,y1,x1,y2+1,1);
		OLED_DrawLine(x2,y1,x2,y2+1,1);
}
...
void OLED_ShowChinese(u8 x,u8 y,u8 num,u8 size1,u8 mode)
{
	u8 m,temp;
	u8 x0=x,y0=y;
	u32 i,size3=(size1/8+((size1%8)?1:0))*size1;  //得到字体一个字符对应点阵集所占的字节数
	for(i=0;i<size3;i++)
	{
		if(size1==16)
...
//	OLED_DisplayTurn(disp_pos);       //0正常显示 1 屏幕翻转显示
}
