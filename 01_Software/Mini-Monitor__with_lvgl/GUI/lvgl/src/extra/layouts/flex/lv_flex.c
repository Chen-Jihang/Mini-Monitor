...
void lv_flex_init(void)
{
    ...
    LV_STYLE_FLEX_MAIN_PLACE = (lv_style_prop_t)(lv_style_register_prop() | LV_STYLE_PROP_LAYOUT_REFR);
    LV_STYLE_FLEX_CROSS_PLACE = (lv_style_prop_t)(lv_style_register_prop() | LV_STYLE_PROP_LAYOUT_REFR);
    LV_STYLE_FLEX_TRACK_PLACE = (lv_style_prop_t)(lv_style_register_prop() | LV_STYLE_PROP_LAYOUT_REFR);
}
